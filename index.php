...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #d6d6d6;">
              
              <div class="col-sm-12 col-md img text-center">
                <img src="img/Rr.png" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createuser.php"><button style="background-color : #1781b1;" style="border-radius:10%">Create a User</button></a>
                  </div>
                  <div class="col-md act">
